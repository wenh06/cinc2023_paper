...
\node [wideblock, below = \blockdist of stem] (bottleneck) {4 $\times$ SE-Bottleneck};
...
\draw[rounded corners, ultra thick] ([xshift = -105, yshift = -5]prob.south) rectangle ([xshift = 105, yshift = 5]input.north);
