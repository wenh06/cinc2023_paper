...
We used a {\color{red}T}ime-{\color{red}i}ncremental {\color{red}C}onvolutional {\color{red}R}ecurrent {\color{red}N}eural {\color{red}N}etwork ({\color{red}TiCRNN}) model to predict probabilities of CPC scores for the EEG recordings.
...
\headerbox{Submission Results}{name=submission, span=2, column=0, below=nn}{
% finished
...
Hidden validation & \textbf{0.701} & 0.33 & 0.40 & 0.75 \\
Ranking & \textbf{5 / 270} & - & - & - \\
\hlineB{3.5}
\end{tabular}
\end{center}
